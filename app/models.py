...
class Movie(models.Model):
    ...
    user = fields.ForeignKeyField(
        "models.User", related_name="author", on_delete=fields.CASCADE)
...
class MovieGenre(models.Model):
    ...
    movie = fields.ForeignKeyField(
        model_name='models.Movie', on_delete=fields.CASCADE)
    genre = fields.ForeignKeyField(
        model_name='models.Genre', on_delete=fields.CASCADE)
